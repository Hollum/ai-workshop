...
import { answerPrompt, condenseQuestionPrompt } from "@/oppgaver/kokebok/prompts/prompts";
import { debugGraph } from "@/utils/debugGraph";
import { combineDocumentsFn, formatChatHistory, removeLastMessage } from "@/utils/mappers";
...
export const kokebokGraph3 = async () => {
